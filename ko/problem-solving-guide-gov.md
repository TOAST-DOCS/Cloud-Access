...
* 라우트 설정
    * 자세한 내용은 [콘솔 사용 가이드 - 시작하기](https://docs.alpha-gov-nhncloud.com/ko/Security/Cloud%20Access/ko/console-user-guide/cloud-access-start/)를 참고하세요.
* ACL 정책 설정
...
!!! tip "문제가 해결되지 않을 경우"
    ...
    * [온라인 1:1 문의 바로가기](https://www.alpha-gov-nhncloud.com/kr/support/inquiry?alias=tab16_15)
