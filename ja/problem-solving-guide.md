<!-- pre-align:aligned sig=ef274e4a6c71 -->
...
<a id="section-1"></a>
## 에이전트를 연결했으나 인스턴스에 접속되지 않습니다. { #section-1 }
...
<a id="section-2"></a>
## 윈도우 사용자인데 생체 인증이 적용되지 않습니다. { #section-2 }
...
<a id="section-3"></a>
## 사용자 계정이 생성되어 있는데 사용자 객체 추가 버튼을 누르면 항목이 나타나지 않습니다. { #section-3 }
...
<a id="section-4"></a>
## 비밀번호 정책을 사용으로 설정했는데 조건에 맞지 않는 비밀번호로도 로그인이 가능합니다. { #section-4 }
...
<a id="section-5"></a>
## 초기 비밀번호 강제 변경을 설정했지만 로그인 시 변경 화면이 나타나지 않습니다. { #section-5 }
...
<a id="section-6"></a>
## 계정 연결 버튼을 클릭했는데 활성화된 서비스가 없다는 팝업이 나옵니다. { #section-6 }
...
<a id="section-7"></a>
## 판교 리전과 평촌 리전 모두에서 서비스를 활성화한 뒤 한 리전만 비활성화할 수 없습니다. { #section-7 }
